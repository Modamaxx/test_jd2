...
public class ProfileService implements IProfileService {
    ...
    public ProfileService(IProfileDao profileDao, UserHolder userHolder, IUserService userService, ICalculationService calculationServicel) {
        this.profileDao = profileDao;
        this.userHolder = userHolder;
        this.userService = userService;
        this.calculationService= calculationServicel;
    }
    ...
    public ProfileDto get(Long id) {
        ...
        return calculationService.norma(profile);
    ...
    @Override
    public Page<Profile> getAll(BaseFilter filter) {
