...
public class JournalsFoodService implements IJournalsFoodService {
    ...
    @Override
    public Page<Journal> getAll(Long idProfile, JournalFilter filter) {
    ...
    public List<Journal> getOneDay(Long idProfile, long day) {
        ...
        LocalDateTime endStart = startDay.minusDays(1);
        return journalDao.findAllByProfileIdAndDtCreateBetween(idProfile,  endStart,startDay);
    }
